...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-love-50 to-rose-50 py-16 md:py-24">
      <div className="absolute top-0 right-0 w-full h-full bg-[url('https://images.unsplash.com/photo-1618160702438-9b02ab6515c9?auto=format&fit=crop&w=1200&q=80')] bg-cover opacity-5"></div>
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 mb-8 md:mb-0 md:pr-8 z-10">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif leading-tight mb-6 fade-in">
              Elegance for <span className="text-love-600 italic">Every</span> Occasion
            </h1>
            ...
            <div className="space-x-4 fade-in">
              <Button className="bg-love-500 hover:bg-love-600 text-white px-8 py-6 rounded-md shadow-md hover:shadow-lg transition-all duration-300">
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            <div className="absolute -top-5 -right-5 bg-rose-50 p-4 rounded-full shadow-lg hidden md:block animate-fadeIn">
