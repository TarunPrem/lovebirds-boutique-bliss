        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="flex flex-col items-center text-center">
            <div className="w-14 h-14 rounded-full bg-love-50 flex items-center justify-center mb-4">
              <Heart size={24} className="text-love-600" />
            </div>
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-14 h-14 rounded-full bg-love-50 flex items-center justify-center mb-4">
              <BadgeCheck size={24} className="text-love-600" />
            </div>
            <h3 className="font-medium text-gray-800 mb-2">Quality Guaranteed</h3>
            <p className="text-sm text-gray-600">We only use the finest silver and ruby materials.</p>
          </div>
          
          <div className="flex flex-col items-center text-center">
            <div className="w-14 h-14 rounded-full bg-love-50 flex items-center justify-center mb-4">
              <Gift size={24} className="text-love-600" />
            </div>
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-14 h-14 rounded-full bg-love-50 flex items-center justify-center mb-4">
              <StarHalf size={24} className="text-love-600" />
            </div>
